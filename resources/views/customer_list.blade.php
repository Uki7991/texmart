...
@section('content')
    ...
    <div class="container pt-5 mt-5">
        <div class="row">
            <div class="left-customer col-8 col-md-8">
                <div class="block-customer">
                    <div class="date-customer">12.09.2019</div>
                    <h1 class="customer-title" style="font-size: 1.5rem">Куплю ткани для оптового закупа. Особенно интересуют трикотаж, лён, кашемир. Интересует
