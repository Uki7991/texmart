                        ...
                        <div class="form-row">
                            ...
                            <div class="col-12 col-sm-10 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ old('address') }}" class="form-control @error('address') is-invalid @enderror" name="address" id="address" required>
                                    @error('address')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                        </span>
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-12 col-sm-12 col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="email" {!! old('email') !!} name="email" class="form-control @error('email') is-invalid @enderror" id="email" placeholder="Email">
                                    @error('email')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                        </span>
