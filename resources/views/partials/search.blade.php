<div class="input-group mr-auto col-12">
    <input type="text" id="search-input-select2" autocomplete="off" class="form-control rounded-pill rounded-right-0 border-right-0 bg-transparent text-{{ $color ?? 'dark' }}" aria-label="Найти..." aria-describedby="basic-addon2">
