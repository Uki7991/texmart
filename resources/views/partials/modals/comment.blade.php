<a href="{{ auth()->check() ? '' : '/login' }}"  class="btn btn-amber btn-sm font-weight-bold" {{ auth()->check() ? 'data-toggle=modal data-target=#exampleModalCenter' : '' }}>
    Оставьте отзыв
</a>
                ...
                <div class="modal-body">
                    <div class="row align-items-center">
                        <div class="col-12 d-flex h-25 align-items-center">
                            ...
                            @include('partials.btn.rateYo', ['id' => 'rateYo-comment'])
                        </div>
                        <div class="col-12 order-1">
                            ...
                            <form action="{{ route('productions.feedback', $production) }}" method="POST" class="">
                                ...
                                <div class="d-flex align-items-center justify-content-end">
                                    <a href="#" class="text-muted mr-4" data-dismiss="modal">Отмена</a>
                                    <button type="submit" class="btn btn-sm btn-success rounded-0">Отправить</button>
                                </div>
                            </form>
                        </div>
                    </div>
