        ...
        <div class="row py-4">
            <div class="col">
                <div class="container">
                    ...
                    <p>Мы знаем Ваши потребности и можем удовлетворить их, знаем как помочь Вам в решении
                        Ваших каждодневных проблем - поиска производителей и заказчиков швейной и текстильной продукций и изделий.</p>
                    <p>Не всегда поиски на разных сайтах, форумах дают положительный результат, зачастую это оборачивается пустой тратой времени
                        ...
                        бизнесу оперативность и эффективность капиталовложений пользователей платформы.</p>
                    ...
                    <ul>
                        ...
                        <li>единая база предприятий легкой промышленности, более 5000 производителей швейной и текстильной продукции Кыргызской
                            Республики;</li>
                        <li>подробную информацию о каждом производителе; производительная мощность, количество сотрудников, марки и модели
                            оборудований на котором они работают и многое другое;</li>
                        <li>контакты и фактическое местоположение на карте. вам откроется возможность напрямую связаться с каждым производителем минуя всех возможных посредников;</li>
                        <li>рейтинг и оценка деятельности каждого производителя или предприятия предоставляющего услуги для швейной и
                    ...
                    <ul>
                        ...
                        <li>оценка и инспекция качества продукции на всех этапах производства по международным стандартам;</li>
                    ...
                    <h4>Также у нас:</h4>
                    <ul>
                        <li>поиск, подбор, заключение контракта, выкуп и прямые поставки тканей, фурнитуры и оборудования из КНР с заводов и фабрик производителей;</li>
